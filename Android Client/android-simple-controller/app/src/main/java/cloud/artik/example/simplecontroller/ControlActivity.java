    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    ArtikCloudSession.getInstance().sendOnbuzzerInDeviceChannelWS();
                } catch (Exception e) {
        ...
        offBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    ArtikCloudSession.getInstance().sendOffbuzzerInDeviceChannelWS();
                } catch (Exception e) {
                    Log.v(TAG, "Run into Exception");
                    e.printStackTrace();
                }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArtikCloudSession.getInstance().sendedittextInDeviceChannelWS(temp);
            }
        });
